...
Route::get('/uniquePost', function () { return view('pages.uniquePost'); })->name('uniquePost');
Route::get('/uniqueLoopi', function () { return view('pages.uniqueLoopi'); })->name('uniqueLoopi');
